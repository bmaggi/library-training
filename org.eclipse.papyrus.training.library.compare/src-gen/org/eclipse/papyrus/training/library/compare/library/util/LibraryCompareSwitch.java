 ...
 * @generated
 */
public class LibraryCompareSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LibraryComparePackage.BOOK_THEFT_DIFF: {
				BookTheftDiff bookTheftDiff = (BookTheftDiff)theEObject;
				T result = caseBookTheftDiff(bookTheftDiff);
				if (result == null) result = caseUMLDiff(bookTheftDiff);
				if (result == null) result = caseDiff(bookTheftDiff);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Book Theft Diff</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Book Theft Diff</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBookTheftDiff(BookTheftDiff object) {
		return null;
	}
